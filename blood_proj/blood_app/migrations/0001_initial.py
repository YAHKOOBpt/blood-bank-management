# Generated by Django 4.1.2 on 2024-01-02 05:52
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('blood_grou', models.CharField(blank=True, choices=[('A+', 'A+'), ('A-', 'A-'), ('B+', 'B+'), ('B-', 'B-'), ('AB+', 'AB+'), ('AB-', 'AB-'), ('O+', 'O+'), ('O-', 'O-')], max_length=3, null=True)),
